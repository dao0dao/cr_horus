...
describe('TaskListComponent', () => {
  ...
  describe('toggleTaskStatus()', () => {
    ...
    beforeEach(() => {
      mockTasks = [
        { id: 1, name: 'A', date: '2025-11-04', status: 'completed', description: '', showDescription: false },
        { id: 2, name: 'B', date: '2025-11-05', status: 'pending', description: '', showDescription: false },
        { id: 3, name: 'C', date: '2025-11-06', status: 'planned', description: '', showDescription: false },
      ];
    ...
    it('should change completed status to pending and emit update', () => {
      ...
      expect(spy).toHaveBeenCalledWith({ id: 1, status: 'pending' } as TaskStatusUpdate);
    });
    ...
    it('should change pending status to planned and emit update', () => {
      ...
      expect(spy).toHaveBeenCalledWith({ id: 2, status: 'planned' } as TaskStatusUpdate);
    });
    ...
    it('should change planned status to completed and emit update', () => {
      ...
      expect(spy).toHaveBeenCalledWith({ id: 3, status: 'completed' } as TaskStatusUpdate);
    });
  ...
  describe('toggleDescription()', () => {
    it('should stop propagation and set showDescription to true', () => {
      const task: Task = { id: 1, name: 'A', date: '2025-11-04', status: 'planned', description: '', showDescription: false };
    ...
    it('should stop propagation and set showDescription to false', () => {
      const task: Task = { id: 1, name: 'A', date: '2025-11-04', status: 'planned', description: '', showDescription: true };
      const stopSpy = jasmine.createSpy('stopPropagation');
      const fakeEvent = { stopPropagation: stopSpy } as unknown as Event;
